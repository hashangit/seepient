...
Start by finding the relevant code. Use `search_files` to find directories and files and to locate key symbols, `read_file` to understand the actual implementation. Don't guess from names. Read the code.
